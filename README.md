...
<img src=”media/3.Ciclo de vida de la aplicacion/3-7.png height=”400” width=”550”/><br>
...
<img src=”media/3.Ciclo de vida de la aplicacion/3-11(para que salga la barra superior donde estan las opciones file, view etc, hay que darle a _esc_ en el teclado).png” height=”400” width=”550”/>
<br>
...
<img src=”3.Ciclo de vida de la aplicacion/3-16.png
” height=”400” width=”550”/>
<br>
<p>Subimos la imagen con el nombre de v1</p><br>
<img src=”3.Ciclo de vida de la aplicacion/3-17.png
” height=”400” width=”550”/>
<br>
...
<br>
<p>Nos bajamos la imagen que nos habiamos creado  y subido anteriormente<p><br>
...
<img src= “media/4.Volumenes persistentes/4-3(para comprobar que se ha guardado la base de datos en el host).png
” height="400" width="550"/>
<br>
...
<img src  = “media/4.Volumenes persistentes/4-4.png
” height="400" width="550"/>
 <br>
<p>Cuando presionamos enter en el comando anterior habrá que poner la contraseña que se definió en el MySQL</p><br>
<img src=”media/4.Volumenes persistentes/4-5(en enter password hay que poner la contraseña que pusimos anteriormente en la primera captura).png
” height="400" width="550"/><br>
<p>Para crear un Base de Datos dentro del servidor de MySQL</p>
<img src = “media/4.Volumenes persistentes/4-6(para crear base de datos).png
” height="400" width="550"/>
<br>
...
<img src=”media/4.Volumenes persistentes/4-8(exit para salir de los 2).png
” height="400" width="550"/>
<br>
<p>Eliminamos el contenedor anterior y creamos otro</p><br>
<img src=”media/4.Volumenes persistentes/4-9(eliminamos el contenedor anterior mysql y creamos otro).png
”  height="400" width="550"/>
<br>
<p>Creamos una nueva base de datos llamada dbTest y la visualizamos con el comando propio de MySQL show databases;</p>
<img src=”media/media/4.Volumenes persistentes/4-10(comprobamos que sigue estando las bases de datos creadas anteriormente).png
” height="400" width="550"/>
<br>
...
<img src=”media/5.Wordpress/5-6(y comprobamos que funciona el wordpress).png<br> height=”400” width=”550”/><br>

<p>Por último nos aparece esta página con Wordpress.</p><br>
